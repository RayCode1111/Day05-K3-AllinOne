...
### Reflection cá nhân _(chấm riêng)_
...
## PHẦN 3 — CHECKLIST XÁC MINH 6 MỐC _(TA xác minh theo đúng các ô dưới đây, 2 phút mỗi nhóm; nộp đúng hạn artifact của mốc = điều kiện lấy 5 điểm nộp)_
...
| **CP2 · Bấm được** _(mốc hỗ trợ kỹ thuật — nhóm kẹt kỹ thuật gọi TA tại đây)_ | 12:00 N1 | 17:00 N1 | Prototype Sketch/Mock: flow chính bấm đi hết được + commit đầu                                                                                      | ☐ flow chính bấm hết được ☐ repo có commit                                                                                                     |
